...
public class EventFrequencyTimer {
    ...
    public EventFrequencyTimer(EventHorizon plugin, int eventFrequency, double posWeight, double negWeight, double neutralWeight){
